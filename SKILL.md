...
3. **三档信息区分**（重要）：
   ...
   - **B 档：产品宣称** — 有明确出处（通稿、发布会、官方博客）但**没有具体数据或第三方验证**。可以保留，但正文不显式归因，不写"官方称..."、"火山引擎在通稿中表示..."、"据 OpenAI 博客..."；改写成"标称..."、"目前还缺少独立验证..."、"更适合作为产品宣称看待..."。
...
5. **去伪存真**：
   ...
   - **保留**: 具体技术实现路径、benchmark 数据（产品宣称也保留，但正文只写可信度边界）、明确应用场景、代码复现情况、价格、上下文窗口、模态范围。
...
正文内容生成规则：
- 将 Stage 1 收集到的事实、产品宣称、可信度边界、来源列表整理成写作输入。
